    ...
    var otable = table.DataTable({
        ...
        drawCallback: function(a) {
            ...
            e.column(9, {
                ...
                n !== a && ($(t).eq(e).before('<tr class="group"><td colspan="10">' + a + '<a href="/evaluaciones-indicadores" class="ml-1 pull-right btn m-btn--pill m-btn--air btn-outline-accent btn-sm m-btn m-btn--outline-2x ">Enviar a revisión</a><a href="/evaluaciones-indicadores" class="pull-right btn m-btn--pill m-btn--air btn-outline-metal btn-sm m-btn m-btn--outline-2x ">Guardar y salir</a>' + "</td></tr>"),
                n = a);
            })
        },
        colReorder: true,
